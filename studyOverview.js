(function(global, factory) {
    ...
    function checkDataSpecification(data) {
        ...
        datasets.forEach(function(dataset) {
            dataset.variables = Object.keys(dataset.data[0]); // Attach specified module to dataset.
    ...
    function printSummary(dataset, by) {
        var module = dataset.module;
        module.containers = {
            card: this.containers.cards.filter(function(d) {
                return d.spec === module.spec;
            }),
            header: this.containers.headers.filter(function(d) {
                return d.spec === module.spec;
            }),
            table: this.containers.tables.filter(function(d) {
                return d.spec === module.spec;
            })
        };
                ...
                row.selectAll('td')
                    .data(
                        d3.merge([
                            ...
                            []
                                .concat(_toConsumableArray(module.byValues || []), ['_overall_'])
                                .map(function(cell) {
                                    return (
                                        d.summary.row[cell] || {
                                            numerator: null,
    ...
    function printDataset(dataset, by) {
        //dataset.containers = {
    ...
    function createTable() {
        ...
        var by = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
        this.data.forEach(function(dataset) {
            if (dataset.module) printSummary.call(_this, dataset, by);
            else printDataset.call(_this, dataset, by);
        });
    }
